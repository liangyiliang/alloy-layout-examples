...
run Example1 {
	some disj p0,p1,p2,p3,p4,p5,p6,p7 : Person {
		Person = p0+p1+p2+p3+p4+p5+p6+p7
		Jocelyn = p6
		Hilary = p7
		spouse = Hilary->Jocelyn+Jocelyn->Hilary+p0->p5+p5->p0+p2->p3+p3->p2+p1->p4+p4->p1
		shaken = Hilary->(p3+p4+p5)+Jocelyn->(p3+p4+p5)+p1->p5+p2->(p4+p5)+p3->(Hilary+Jocelyn+p4+p5)+p4->(Hilary+Jocelyn+p2+p3+p5)+p5->(Hilary+Jocelyn+p1+p2+p3+p4)
	}
} for exactly 8 Person, 5 int
